      ...
      <section className="container mx-auto px-4 pb-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/90 max-w-2xl mx-auto text-lg">
            Escolha uma das formas abaixo para contribuir com o nosso projeto e
            fazer a diferença na vida dos animais
          </p>
        </div>
            ...
            >
              <CardHeader className="text-center">
                <div className="mx-auto w-16 h-16 flex items-center justify-center bg-[var(--color-light-orange)]/10 rounded-full mb-4">
                  <span
                    className="text-3xl text-[var(--color-light-orange)]"
                    role="img"
