...
export default function HeroSection() {
  return (
    <section className="relative h-[80vh] flex items-center overflow-hidden bg-gradient-to-r from-[#F4923A] to-[#D94545]">
      <PawPattern />
      ...
      <div className="container mx-auto px-6 flex justify-end items-center h-full z-20">
        ...
        <div className="w-full md:w-1/2 text-white text-right space-y-6 animate-fade-in">
          <h1 className="text-4xl md:text-6xl font-bold">Apoie a Causa</h1>
