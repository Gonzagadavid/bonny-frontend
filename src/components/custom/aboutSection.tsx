...
export default function AboutSection() {
  return (
    <section
      className="bg-white py-16 md:py-20 lg:py-24 relative overflow-hidden"
      id="sobre"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 text-left">
            ...
            <div className="space-y-6 text-lg md:text-xl text-gray-700 leading-relaxed animate-fade-in">
              <p>
                Fundado em <b>2018</b>, o projeto Bonny nasceu muito antes,
                impulsionado pelo carinho e dedicação aos animais em situação de
                risco. O nome Bonny foi escolhido em homenagem ao primeiro
