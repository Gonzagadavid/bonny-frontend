...
export default function CtaEndAbout() {
    ...
    <section className=" relative bg-[--color-red-orange] text-white py-20 text-center">
        ...
        <div className="container mx-auto px-4">
            <h2 className="sm:text-2xl md:text-3xl font-bold mb-6">{aboutData.cta.title}</h2>
            <Button asChild variant="secondary" className="bg-amber-600 hover:bg-amber-700 text-white hover:text-white focus:text-white active:text-white">
