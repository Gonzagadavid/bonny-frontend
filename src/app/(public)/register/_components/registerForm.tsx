...
const formSchema = z
  .object({
    ...
    cellPhone: z
      ...
      .regex(/^\(\d{2}\) \d{5}-\d{4}$/, { message: "Formato de telefone inválido. Use (XX) XXXXX-XXXX" }),
    password: z
      .string()
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="grid md:grid-cols-2 gap-4 mb-4">
          <FormFieldInput control={form.control} name="name" label="Nome Completo" className="w-full" />

          <FormFieldInput control={form.control} name="email" label="Email" inputType="email" className="w-full" />
        </div>
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <div className="p-3 border-b">
                      ...
                      <FormDescription className="text-xs text-gray-600">
                        Digite a data no formato DD-MM-YYYY ou use o calendário abaixo
                      </FormDescription>
                    </div>
                    <Calendar
                      mode="single"
        ...
        <div className="mb-4">
          <FormFieldInput control={form.control} name="individualTaxpayerRegistry" label="CPF" className="w-full" />
        </div>
