                  ...
                  <div className="p-6 bg-gradient-to-br from-[#f4e4d0]/70 to-[#f4e4d0]/30 border-r border-[#f4923a]/20">
                    <div className="flex flex-col items-center mb-6">
                      <Avatar className="w-[60%] h-[60%] mb-4 border-4 border-[#f4923a]/30 shadow-md">
                        <AvatarImage
                          src={
                            dog.imageProfile || "/images/path/placeholder.svg"
                          }
                          alt={dog.name}
                        />
                        ...
                        <p className="text-sm leading-relaxed text-[#803033]/90">
                          ...
                          status === CandidacyStatus.APPROVED ? (
                            ...
                            <>
                              ...
                              começa. 🐶❤️
                              <br />
                              Agora daremos início ao acompanhamento do
                              pós-adoção para garantir que tudo continue indo
                              bem. 🐾
                            </>
                          ) : (
                            <>
                              ...
                              encontrou um novo lar! 🏡 Agradecemos imensamente
                              o seu carinho e interesse. Ainda há muitos outros
