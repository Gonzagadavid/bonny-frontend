...
export const aboutData = {
  ...
  team: {
    title: "Nossa Equipe",
    members: [{ name: "Ana Silva", role: "Fundadora", image: "/team/ana.jpg" }],
  },
  cta: {
  ...
  sponsors: [
    {
      name: "PetLovers",
      description:
        "Apoiadora oficial desde 2021, fornecendo alimentos e remédios.",
      logo: "/sponsors/petlovers.png",
    },
    {
      name: "Clínica Vet&Cia",
      description:
        "Responsável pelos cuidados veterinários de nossos resgatados.",
